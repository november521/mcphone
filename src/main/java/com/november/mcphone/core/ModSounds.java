...
public final class ModSounds {
    ...
    // 1.21.1 那边收的是 Registries.SOUND_EVENT（原版的 ResourceKey）；
    // Forge 1.20.1 收的是 ForgeRegistries.SOUND_EVENTS（Forge 自己的包装），
    // 名字像但不是同一个东西，见 docs/PORTING.md 第 6 条
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, MCphone.MODID);

    /** 手机外放网络音乐用的壳。音频由 SoundInstance 自己供，见类注释 */
    public static final RegistryObject<SoundEvent> DISC_STREAM =
