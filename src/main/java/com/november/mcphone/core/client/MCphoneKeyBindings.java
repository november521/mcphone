...
public final class MCphoneKeyBindings {
    ...
    /**
     * Fabric 没有 NeoForge 的 {@code RegisterKeyMappingsEvent} 与
     * {@code KeyConflictContext}：注册走 {@link KeyBindingHelper}，按键也因而
     * 没有"仅在游戏内生效"的上下文 —— 消费端（各 tick 处理函数）本来就只在
     * 对应界面状态下读它们，行为一致。
     */
    public static void register() {
        ...
        KeyBindingHelper.registerKeyBinding(HUD_INTERACT);
        KeyBindingHelper.registerKeyBinding(HUD_TOGGLE);
    }
}
