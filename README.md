...
| 🎵 音乐 | 播放 `config/mcphone/music/` 下你自己的音乐与游戏里的唱片（含模组加的）：播放 / 暂停 / 继续、上一首下一首、三种循环模式、进度条、音量。支持 OGG / MP3 / WAV。另有**唱片仓**——把唱片放进手机，声音跟着你走，**周围的人也听得见** |
...
**音乐的两条路**：曲库里点一首是「耳机」——自己解码，只有你听得见，能暂停、能看进度。唱片仓是「外放」——手持唱片点一下放进去，服务端播原版音效，**周围人都听得见，声音跟着你走**，就像扛着一台唱片机。外放只有播和停，没有暂停：原版音效系统里没有"从中间接着放"这回事。
