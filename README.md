...
| 💬 美西螈 | 手机上的聊天 App。双向好友（申请 / 同意 / 拒绝）、会话列表（未读数、在线状态、最后一条预览）、气泡式会话界面。消息存进世界存档，对方离线也能发。点在线好友的头像就传送到他身边 |
...
**传送到好友身边**：**点好友的头像**，人就过去了，手机同时自动关掉。落点与原版 `/tp 玩家 玩家` 一模一样——落在他站的那个坐标上，朝向也和他一致。跨维度也传，他在下界你在主世界照样过去。只有在线的好友才能点，鼠标停上去头像会亮一圈，第二行那句预览也会临时换成提示。
...
| `chat/teleport_ring.png` | 停在在线好友头像上时，头像外那一圈「点它就传过去」 | 20×20（画在 16 的头像底下，四边各露 2） | 画一圈 1px 描边 |
