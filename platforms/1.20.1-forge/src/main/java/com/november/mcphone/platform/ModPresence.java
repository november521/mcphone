 ...
 *
 * 收进这里之后，两支之间要改的就只剩这个文件里的一行 import —— 这一份就是那一行
 * 换成 Forge 的结果，其余逐字相同。
 *
 ...
 *
 * <ul>
 *   <li>{@code compat/CompatModule} —— 事件总线
 *   <li>{@code feature/settings/client/AppManagerDetail} —— 按键修饰符
 *   <li>{@code feature/terminal/integration/Terminals} —— 生命周期事件
 * </ul>
 *
 ...
 * 眼下只有这一个。<b>不要往这里放业务逻辑</b> —— 判断"装了 Waystones
