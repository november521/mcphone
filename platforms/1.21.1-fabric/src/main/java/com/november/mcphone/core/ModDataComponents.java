...
public final class ModDataComponents {
     ...
     */
    public static final Holder<DataComponentType<String>> DEVICE_NAME = Holder.of(DataComponentType.<String>builder()
     ...
     */
    public static final Holder<DataComponentType<Boolean>> SCREEN_ON = Holder.of(DataComponentType.<Boolean>builder()
    ...
    public static void register() {
        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
                ...
                SCREEN_ON.get());
        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
                ResourceLocation.fromNamespaceAndPath(MCphone.MODID, "device_name"),
                DEVICE_NAME.get());
    }
}
